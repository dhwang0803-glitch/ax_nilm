...
| 03 | dashboard | **구현 완료** (PR #44 머지) | 분석형 변형 C — 좌 2/3 차트(주간 페어 + 월별) + 우 1/3 KPI 3개 + 가전별 점유율 |
| 04 | usage | **구현 완료** (PR #45 머지) | 종합 분석 변형 A — 주간 페어 + 24h 라인 + 가전 분해 표 + 월별 |
| 05 | cashback | **작성 완료** | 목표 트래커 변형 C — 진행바 + grid-2 차트(재사용) + 오늘의 미션 표 |
