...
- nilm.anomaly_flags: baseline 대비 비정상 플래그 (과소비/장시간)
- nilm.mode_references: 가전별 모드 baseline (정상 운전 기준값). 각 가전의 modes에 avg_energy_wh, avg_duration_min, standby_avg_w 포함.
- nilm.recent_events: 최근 가전 사용 이벤트 (실제 energy_wh, avg_w, peak_w 포함)
